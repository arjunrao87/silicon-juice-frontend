      ...
      <div>
        ...
        <main className="text-gray-900">
          <section className="pt-20 md:pt-40">
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none text-orange-600">
                  Silicon Juice
                </h1>
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  Searchable database of venture capital activity in the Valley!
                </p>
                <p className="mt-8 md:mt-12 flex justify-center lg:justify-start ">
                  <iframe
                ...
                <p className="mt-4 text-gray-600 flex justify-center lg:justify-start ">
                  Sign up to stay notified of the latest funding activity!
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Learn about funding rounds, investors, and the company,
                      all in one view!
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Always kept up-to-date so you have the latest information
                      at your fingertips!
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Rapid search capabilities that allow you to narrow down
          ...
          <section className="container mx-auto my-20 py-24 bg-gray-200 rounded-lg text-center">
            <h3 className="text-5xl font-semibold">Ready to jump in?</h3>
            <p className="mt-8">
              <button
                type="button"
              ...
              >
                <Link
                  href="/investments"
                  className="text-lg hover:text-blue-dark"
                >
                  View Investments
                </Link>
              </button>
